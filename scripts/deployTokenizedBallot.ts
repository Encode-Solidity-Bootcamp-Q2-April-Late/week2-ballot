...
async function main() {
    ...
    const acc2 = ethers.utils.getAddress("0x067c158F0bA8E8c90cB72045Cdf82988d8243b65");
    const acc3 = ethers.utils.getAddress("0x95C07028025848f840BA1d7695266E6229eae853");
// Deploy contract
